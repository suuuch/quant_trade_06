...
- RSI 使用 RSI(14)，并且曾进入 45–55；
- 多头信号日 RSI 位于 45–55，T-5 至 T 全部位于 50–58；
- 空头信号日 RSI 位于 42–50，T-5 至 T 全部位于 42–50；
...
美股使用相同的方向化 RSI 条件，但不启用 40° 门槛，只判断 MA20 和 MA30 的
...
W 底和 M 顶已经从 RSI50 策略中解耦，通过单独的扫描器运行，不叠加 RSI
或均线条件：
...
避免覆盖 K 线。
均线及 RSI 仅供观察，不参与 W/M 筛选，也不会改变 RSI50 的扫描结果。
