...
_LISTENER_SCRIPT_PATH = Path(__file__).parents[1] / "scripts" / "run_qq_signal_listener.py"
...
parse_listener_args = cast(Callable[[], argparse.Namespace], _LISTENER_MODULE.parse_args)
