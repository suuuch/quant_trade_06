"""Run the scheduled A-share scanner and QQ group command listener."""
...
def parse_args() -> argparse.Namespace:
    """Parse service scheduling and delivery options."""
...
def main() -> None:
    """Load configuration and keep the service running."""
    args = parse_args()
